...
class formulario_reporte_fallas_app extends StatefulWidget {
  @override
  bool editable;
  String id_reporte;
  formulario_reporte_fallas_app(
      {required this.editable, required this.id_reporte});
  _formulario_reporte_fallas_appState createState() =>
      _formulario_reporte_fallas_appState();
}

class _formulario_reporte_fallas_appState
    extends State<formulario_reporte_fallas_app> {
