  ...
  Future<void> getPorcentaje() async {
    ...
    try {
      final response = await http.post(
        Uri.parse(
            '${conexion}phicargo/aplicacion/viajes/porcentaje_cumplimiento.php'),
        body: {
      ...
      if (response.statusCode == 200) {
        ...
        if (data.isNotEmpty) {
          var statusCount = data[0]['status_count'].toString();
          var porcentajeCumplimiento =
              data[0]['porcentaje_cumplimiento'].toString();
